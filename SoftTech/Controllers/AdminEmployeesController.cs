...
namespace SoftTech.Controllers
{
    ...
    public class AdminEmployeesController : Controller
    {
        ...
        public AdminEmployeesController(IUserAdministrationService service)
        {
        ...
        public async Task<ActionResult> Create(Employee employee, string role)
        {
            try
            {
                ...
                string body = Utilities.Utilities.getEmailBody(employee.name_emp, user_name, secure_password, role);
